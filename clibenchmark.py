...
def main():
    ...
    spmv_cpu_sell_benchmark(matrix_data, slice_height, t)

    os.environ['PYOPENCL_CTX'] = '0'
    spmv_gpu_csr_benchmark(matrix_data, t)
    spmv_pycuda_csr_benchmark(matrix_data, t)
    spmv_gpu_sell_benchmark(matrix_data, slice_height, t)
    spmv_pycuda_sell_benchmark(matrix_data, slice_height, t)
