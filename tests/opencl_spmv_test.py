...
from FasterSpMV.opencl_spmv import OclSELLSpMV
from FasterSpMV.opencl_spmv import OclCSRSpMV
...
def test_spmv():
    ...
    ell_colidx, ell_sliceptr, ell_slicecol, ell_val = \
        csr_to_sell(csr_rowptr, csr_colidx, csr_val, slice_height)
    ...
    sell_spmv = OclSELLSpMV(n_row, slice_count, ell_sliceptr, ell_slicecol,
